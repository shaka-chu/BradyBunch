...
% Function Name: controls1 - Elevator input
%
...
function U_manoeuvre = controls1(Params, X, U_trimmed, currentTime)

    % Quesiton 1, elevator deflection of 5 degrees
    E_deflection = deg2rad(15);
    
    % Set new vector
    U_manoeuvre = U_trimmed;
    
    % Change elevator deflection for 0.5 seconds by 5 deg
    if currentTime > 10 && currentTime < 10.5 

        U_manoeuvre(2) = E_deflection;
