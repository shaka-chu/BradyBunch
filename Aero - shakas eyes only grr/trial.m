...
fid                 = fopen(fileName,'r');
wing_tip_xfoil_1   = textscan(fid,'%f %f %f %f %f %f %f','Headerlines',2);
top_xtr_wing_tip_1 = wing_tip_xfoil_1{6};
bot_xtr_wing_tip_1 = wing_tip_xfoil_1{7};
fclose('all');
fileName            = 'naca762415_w_tip_2_text.txt';
fid                 = fopen(fileName,'r');
wing_tip_xfoil_2   = textscan(fid,'%f %f %f %f %f %f %f','Headerlines',2);
...
fid                 = fopen(fileName,'r');
tail_root_xfoil     = textscan(fid,'%f %f %f %f %f %f %f','Headerlines',2);
top_xtr_tail_root   = tail_root_xfoil{6};
bot_xtr_tail_root   = tail_root_xfoil{7};
fclose('all');

% Tail tip data (same as tail root - constant chord = constant Reynolds)
top_xtr_tail_tip = top_xtr_tail_root;
bot_xtr_tail_tip = bot_xtr_tail_root;
