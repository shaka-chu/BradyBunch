function Cf_avg = tailPlateCoef(Re, TransPoints)
    ...
    xtrc_upper_root  = TransPoints.Tail.Upper;
    xtrc_lower_root  = TransPoints.Tail.Lower;
    xtrc_upper_tip   = TransPoints.Tail.Upper;
    xtrc_lower_tip   = TransPoints.Tail.Lower;
