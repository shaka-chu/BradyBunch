function [fig1, fig2, fig3, fig4] = plotTimeSeries(V, X, time, tlim, plotResults)
    ...
    if plotResults
        ...
        set(gca, 'Color', [1 1 1]);
        grid on
        print(fig1, 'cruise1_tSeries_aileron_alphaBeta', '-depsc') 
        ...
        set(gca, 'Color', [1 1 1]);
        grid on
        print(fig2, 'cruise1_tSeries_aileron_rotRates', '-depsc') 
...
%         set(gca, 'Color', [1 1 1]);
%         grid on
%         print(fig3, 'cruise1_tSeries_aileron_attitudes', '-depsc') 
        ...
        set(gca, 'XLimSpec', 'Tight');
        grid on
        print(fig4, 'cruise1_tSeries_aileron_velocities', '-depsc') 
        
%         % Plot altitude
%         fig5 = figure;
%         plot(time, X(5, :));
%         xlabel('Time (sec)');
%         ylabel('Earth Axis Altitude (m)')
%         set(gcf, 'Color', [1 1 1]);
%         set(gca, 'Color', [1 1 1]);
%         set(gca, 'XLimSpec', 'Tight');
%         grid on
%         print(fig5, 'cruise1_tSeries_aileron_altitude', '-depsc') 
